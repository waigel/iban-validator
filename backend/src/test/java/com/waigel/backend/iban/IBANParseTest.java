...
public class IBANParseTest {
  ...
  @Test
  @DisplayName(
      "Test if the IBAN parser throws an exception if the first check digit are not numeric")
  ...
  @Test
  @DisplayName(
      "Test if the IBAN parser throws an exception if the last check digit are not numeric")
  ...
  @Test
  @DisplayName(
      "Test if the IBAN parser throws an exception if the IBAN contains invalid country code")
  public void throwExceptionWhenContainsInvalidCountryCode() {
    final Exception exception =
        assertThrows(
            CountryCodeInvalidException.class,
            () -> {
