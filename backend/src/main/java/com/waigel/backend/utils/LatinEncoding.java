...
/**
 * Utils to encode latin chars in a string to the numbers. This is required for the country code and
 * any letter in the bank account.
 */
public class LatinEncoding {
  private static final List<String> lookupChars =
      Arrays.asList(
